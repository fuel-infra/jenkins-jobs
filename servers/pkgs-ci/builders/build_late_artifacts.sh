...
# shellcheck disable=SC2129
echo "RPM_OS_REPO_PATH=mos-repos/centos/mos8.0-centos7-fuel/os              " >> "${ARTS_DIR}/buildresult.params"
echo "RPM_PROPOSED_REPO_PATH=mos-repos/centos/mos8.0-centos7-fuel/proposed  " >> "${ARTS_DIR}/buildresult.params"
echo "RPM_UPDATES_REPO_PATH=mos-repos/centos/mos8.0-centos7-fuel/updates    " >> "${ARTS_DIR}/buildresult.params"
