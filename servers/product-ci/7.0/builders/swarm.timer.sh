...
JENKINS_TEST_BUILD_URL="${JENKINS_URL}job/7.0.test_all/lastSuccessfulBuild/"
...
curl -O "${JENKINS_TEST_BUILD_URL}artifact/mirror_ubuntu.txt"
...
cat ubuntu_mirror_id.txt mirror_ubuntu.txt >> links.txt
