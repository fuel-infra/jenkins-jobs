...
LATEST_UBUNTU_SNAPSHOT=$(curl -sSf http://perestroika-repo-tst.infra.mirantis.net/mos-repos/ubuntu/7.0.target.txt | head -1)
...
LATEST_CENTOS_SNAPSHOT=$(curl -sSf http://perestroika-repo-tst.infra.mirantis.net/mos-repos/centos/mos7.0-centos6-fuel/os.target.txt | head -1)
