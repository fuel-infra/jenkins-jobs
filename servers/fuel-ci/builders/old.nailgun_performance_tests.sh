...
lastSuccessfulBuild=$(wget -q "${JENKINS_URL}job/old.nailgun_performance_tests/lastSuccessfulBuild/buildNumber" -O -)
echo "Last completed build: ${lastSuccessfulBuild}"
