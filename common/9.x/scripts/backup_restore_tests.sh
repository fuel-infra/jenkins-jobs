...
#   :mod: `backup_restore_tests` -- upgrade tests build starter
#   ================================================================
#
#   .. module: backup_restore_tests
#       :platform: Unix
...
#
#
#   The tests are executed for Fuel 9.x to 9.x upgrade.
...
#    EXTRA_DEB_9=""
        ...
        if [[ "${ENABLE_PROPOSED}" = true ]]; then
            # TODO: add 9.x link
            #UPDATE_FUEL_MIRROR="http://${MIRROR_HOST}/${PROPOSED_9}"
            #EXTRA_DEB_REPOS="${REPO} http://${MIRROR_HOST}/${EXTRA_DEB_9}"
